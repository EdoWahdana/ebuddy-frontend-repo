...
import { Container, Box, Typography, Button, Paper, useTheme, useMediaQuery } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box sx={{ transform: 'scale(1.2)', mb: 4 }}>
            <Image
              ...
              priority
              style={{
                filter: theme.palette.mode === 'dark' ? 'drop-shadow(0 0 0.5rem rgba(255,255,255,0.2))' : 'none'
              }}
            />
          </Box>
        ...
        >
          <IconButton href="https://github.com" target="_blank" icon={<GitHubIcon />} />
          <IconButton href="https://linkedin.com" target="_blank" icon={<LinkedInIcon />} />
        </Box>
      </Box>
    </Container>
  );
